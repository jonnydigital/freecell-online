...
- Watch GA4 for `next_action_tap` by `action` and `surface` after the next data refresh; use that signal to decide whether the panel should promote Hint, Undo, or learning links differently by game.
