...
17. **i18n** — multi-language. First slice shipped 2026-07-01 with `/freecell-en-espanol` Spanish rules/play landing page. Playable Spanish UI shipped 2026-07-02 at `/freecell-en-espanol/jugar`; Spanish win-screen/settings polish shipped 2026-07-02 morning; Spanish home overlay date locale shipped 2026-07-02 evening. Next step is additional language hubs and any remaining secondary modal localization.
