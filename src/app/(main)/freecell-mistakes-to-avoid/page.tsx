  ...
  return (
    <ContentLayout variant="dark">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 pb-20 space-y-6">
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #1">Moving Aces to Foundations Too Early</SectionHeading>
            <ContentBody variant="dark" className="grid gap-4 md:grid-cols-2">
              <div className="rounded-xl border border-white/[0.07] p-5">
                <h3 className="text-lg font-semibold text-white mb-2">The instinct</h3>
              ...
              <div className="rounded-xl border border-white/[0.07] p-5">
                <h3 className="text-lg font-semibold text-white mb-2">The real cost</h3>
                <p className="text-white/70 text-sm leading-7">
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #2">Filling Free Cells Too Quickly</SectionHeading>
            <ContentBody variant="dark" className="space-y-5">
              ...
              <div className="bg-white/[0.05] border border-white/[0.07] rounded-xl p-6">
                <h3 className="text-lg font-semibold text-white mb-3">The supermove math</h3>
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #3">Ignoring Empty Columns</SectionHeading>
            <ContentBody variant="dark" className="grid gap-4 md:grid-cols-2">
              <div className="bg-white/[0.05] border border-white/[0.07] rounded-xl p-5">
                <h3 className="text-lg font-semibold text-white mb-2">Worth more than a free cell</h3>
                <p className="text-white/70 text-sm leading-7">
              ...
              <div className="bg-white/[0.05] border border-white/[0.07] rounded-xl p-5">
                <h3 className="text-lg font-semibold text-white mb-2">When to fill one</h3>
                <p className="text-white/70 text-sm leading-7">
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #4">Not Planning Ahead</SectionHeading>
            <ContentBody variant="dark" className="space-y-5">
              <p>
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #5">Focusing on One Column</SectionHeading>
            <ContentBody variant="dark" className="grid gap-4 md:grid-cols-2">
              <div className="rounded-xl border border-white/[0.07] p-5">
                <h3 className="text-lg font-semibold text-white mb-2">The tunnel-vision trap</h3>
                <p className="text-white/70 text-sm leading-7">
              ...
              <div className="rounded-xl border border-white/[0.07] p-5">
                <h3 className="text-lg font-semibold text-white mb-2">Work the whole board</h3>
                <p className="text-white/70 text-sm leading-7">
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #6">Not Uncovering Aces and Low Cards</SectionHeading>
            <ContentBody variant="dark" className="space-y-5">
              <p>
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #7">Moving Cards Just Because You Can</SectionHeading>
            <ContentBody variant="dark" className="grid gap-4 md:grid-cols-2">
              <div className="bg-white/[0.05] border border-white/[0.07] rounded-xl p-5">
                <h3 className="text-lg font-semibold text-white mb-2">Activity is not progress</h3>
                <p className="text-white/70 text-sm leading-7">
              ...
              <div className="bg-white/[0.05] border border-white/[0.07] rounded-xl p-5">
                <h3 className="text-lg font-semibold text-white mb-2">The one-move test</h3>
                <p className="text-white/70 text-sm leading-7">
        ...
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Mistake #8">Giving Up Too Soon</SectionHeading>
            <ContentBody variant="dark" className="space-y-5">
              <p>
        ...
        {/* ── Expert Quote ── */}
        <CardSection variant="dark">
            <SectionHeading variant="dark" sub="Expert Advice">Words From a FreeCell Pioneer</SectionHeading>
            <ContentBody variant="dark">
              <blockquote className="bg-white/[0.05] border border-white/[0.07] rounded-xl p-6 border-l-4 border-[#D4AF37]/40">
                <p className="text-white leading-8 italic">
        ...
        <CardSection id="faq" variant="dark">
            <SectionHeading variant="dark" sub="Common Questions">FreeCell Mistakes FAQ</SectionHeading>
          ...
          body="Knowing the mistakes is the first step. The second step is loading a deal and playing it with fresh eyes — watching for each habit as it tries to sneak back in."
