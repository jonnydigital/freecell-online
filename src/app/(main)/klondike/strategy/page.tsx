...
export default function KlondikeStrategyPage() {
  ...
  return (
    <ContentLayout variant="dark">
      ...
      <ContentHero
        title="Klondike Solitaire Strategy Guide"
        subtitle="Proven strategies, tips, and techniques for winning more games in both Draw 1 and Draw 3 Klondike."
      />
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-12 pb-20 flex flex-col gap-6">
        <article className="space-y-6">
          ...
          <CtaSection
            ...
            body="Practice makes perfect. Try our free online Klondike Solitaire with Draw 1 and Draw 3 modes, unlimited undo, and instant new deals."
