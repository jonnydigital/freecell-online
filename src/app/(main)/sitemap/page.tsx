...
const playLinks = [
  ...
  { href: "/freecell-auf-deutsch/spielen", label: "FreeCell auf Deutsch", desc: "Playable German FreeCell UI" },
  { href: "/freecell-in-italiano/gioca", label: "FreeCell in Italiano", desc: "Playable Italian FreeCell UI" },
  { href: "/freecell-em-portugues/jogar", label: "FreeCell em Portugues", desc: "Playable Portuguese FreeCell UI" },
...
const learnLinks = [
  ...
  { href: "/freecell-in-italiano", label: "FreeCell in Italiano", desc: "Italian FreeCell rules and play guide" },
  { href: "/freecell-em-portugues", label: "FreeCell em Portugues", desc: "Portuguese FreeCell rules and play guide" },
...
const exploreLinks = [
  ...
  { href: "/why-freecell-is-almost-always-solvable", label: "Why FreeCell Is Almost Always Solvable", desc: "The math behind 99.999% winnability" },
  { href: "/famous-freecell-game-numbers", label: "Famous FreeCell Game Numbers", desc: "Legendary deals every player should know" },
...
const variantGuides = [
  ...
  { href: "/spider/how-to-empty-a-column", label: "How to Empty a Column (Spider)", desc: "The #1 winning move" },
  ...
  { href: "/klondike/vegas-scoring", label: "Vegas Scoring Explained", desc: "Casino solitaire scoring system" },
