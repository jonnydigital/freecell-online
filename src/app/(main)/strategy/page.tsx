  ...
  return (
    <ContentLayout variant="dark">
      ...
      <ContentHero
        ...
        subtitle="The difference between a 50% win rate and 90%+ is pure strategy. This guide covers everything from first principles to expert-level endgame technique."
      />
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10 pb-20 flex flex-col gap-6">
              ...
              {[
                {
                  ...
                  body: (
                    <>
                      Every filled{" "}
                      <Link href="/glossary#free-cell" className="text-[#8B6914] hover:underline">
                        free cell
                      </Link>{" "}
            ...
            {[
              ...
              },
              {
                ...
                body: (
                  <p>
                    Move aces to the{" "}
                    <Link href="/glossary#foundation" className="text-[#8B6914] hover:underline">
                      foundation
                    </Link>{" "}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="card-inset rounded-lg p-5">
                ...
                <p className="text-[#444444] text-sm mb-3">
                  ...
                  <Link href="/game/2" className="text-[#8B6914] hover:underline">
                    Game #2
                  </Link>{" "}
                  and{" "}
                  <Link href="/game/3" className="text-[#8B6914] hover:underline">
                    Game #3
                  </Link>
                  .
                </p>
              ...
              <div className="card-inset rounded-lg p-5">
                ...
                <p className="text-[#444444] text-sm mb-3">
                  ...
                  to solve{" "}
                  <Link href="/game/5" className="text-[#8B6914] hover:underline">
                    Game #5
                  </Link>{" "}
        ...
        {/* ── CTA ── */}
        <CtaSection
          heading="Put Strategy to the Test"
          body="Apply these strategies in a real game. Start with an easy deal or jump into today's Daily Challenge."
          secondaryLabel="Quick Tips"
          secondaryHref="/tips"
        >
          <p className="text-sm text-white/60 mb-6 max-w-2xl mx-auto leading-7">
            ...
            (the only proven unsolvable deal), study what separates{" "}
