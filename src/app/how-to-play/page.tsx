...
function BoardDiagram() {
  return (
    <div className="bg-gradient-to-b from-[#0a4a2a] to-[#073a20] rounded-xl p-4 sm:p-6 my-6 overflow-x-auto">
...
function ColorAlternationDiagram() {
  return (
    <div className="bg-gradient-to-b from-[#0a4a2a] to-[#073a20] rounded-xl p-5 sm:p-6 my-6">
    ...
    <div className="bg-gradient-to-b from-[#0a4a2a] to-[#073a20] rounded-xl p-5 sm:p-6 my-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-5">
        {[
          ...
          <div
            key={`${fc}-${ec}`}
            className="bg-white/[0.06] rounded-lg p-3 text-center text-sm"
          >
  ...
  return (
    ...
    >
      ...
      <header className="relative pt-6 pb-12 sm:pt-8 sm:pb-16 px-4 text-center overflow-hidden">
        ...
        >
          How to Play{" "}
          <span className="text-[#D4AF37]">FreeCell</span> Solitaire
        </h1>
      ...
      <main className="max-w-4xl mx-auto px-4 pb-20">
        ...
        <section id="what-is-freecell" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              complete. This means that when you lose a game of FreeCell, it&apos;s
              almost always because of a strategic error, not bad luck. That&apos;s
              what makes winning so satisfying and what makes improving your
              skills so rewarding. Every game is a puzzle waiting to be solved.
            </p>
          </div>
        </section>

        {/* Section 2: The Board */}
        <section id="the-board" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              <div className="bg-[#f8f6f0] rounded-xl p-4 border border-[#e8e4d8]">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-[#D4AF37] text-lg">●</span>
                  <h3 className="font-bold text-[#062516]">
                    Free Cells
                  </h3>
                </div>
        ...
        {/* Section 3: Setup */}
        <section id="setup" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <div className="bg-[#f8f6f0] rounded-xl p-4 border border-[#e8e4d8] my-5">
                    ...
                    <div
                      className={`w-9 sm:w-11 h-8 sm:h-10 rounded-lg flex items-center justify-center text-sm font-bold ${
                        n === 7
                          ...
                          : "bg-[#062516]/5 text-[#062516]/60 border border-[#062516]/10"
                      }`}
                    >
                      {n}
                    </div>
        ...
        {/* Section 4: Rules */}
        <section id="rules" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <div className="flex gap-4 mb-8">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-[#062516] text-lg mb-2">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  ...
                  <strong>one rank higher</strong> and the{" "}
                  <strong>opposite color</strong>. For example, a red 5 (♥ or ♦)
                  can be placed on a black 6 (♠ or ♣). A black Jack can be
                  placed on a red Queen. But a red 3 cannot go on a red 4 (same
                  color), and a 7 cannot go on a 5 (must be exactly one rank
                  higher).
                </p>
            ...
            <div className="flex gap-4 mb-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 leading-relaxed mb-3">
                  ...
                  the four foundations holds one suit — spades (♠), hearts (♥),
                  diamonds (♦), and clubs (♣). You can only place a card on a
                  foundation if it&apos;s the next card in that suit&apos;s
                  sequence. For example, if the spades foundation currently shows
                  5♠, only 6♠ can go there next.
                </p>
                {/* Foundation build example */}
                <div className="bg-[#f8f6f0] rounded-lg p-4 border border-[#e8e4d8] flex items-center gap-2 overflow-x-auto">
                  ...
                  <span className="text-gray-500 text-sm shrink-0">...K♠</span>
                </div>
        ...
        <section id="supermoves" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            <SectionHeading
        ...
        <section id="first-game" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            <SectionHeading
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <GoldStep n={1} />
                <div>
                  <h3 className="font-bold text-[#062516] mb-1">
                    Scan the Board
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    undo button without hesitation. Undo is not cheating — it&apos;s
                    the single best learning tool available to you. Try a
                    sequence of moves, observe the result, undo if it didn&apos;t
                    work, and try a different path. Over time, you&apos;ll develop
                    the intuition to see dead ends before you reach them.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="winning" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              you&apos;ve won, and in many cases, the final cards will cascade to
              the foundations automatically once the solution becomes
              inevitable.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              not bad luck. This is why FreeCell is so addictive: there is always
              room to improve, and every hard-earned victory feels genuinely
              satisfying.
            </p>

            {/* Win rate bar */}
            <div className="bg-[#f8f6f0] rounded-xl p-5 border border-[#e8e4d8] mt-6">
              <h3 className="font-bold text-[#062516] text-sm mb-4 uppercase tracking-wider">
        ...
        <section id="terminology" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                >
                  <dt className="font-bold text-[#062516] mb-1">{term}</dt>
        ...
        <section id="tips" className="scroll-mt-6 mb-8">
          <div className="bg-white rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.15)] p-5 sm:p-8">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={i}
                  className="flex items-start gap-3 bg-[#f8f6f0] rounded-lg p-4 border border-[#e8e4d8]"
                >
                  <span
