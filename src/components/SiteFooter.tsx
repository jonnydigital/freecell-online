  ...
  const playLinks = visibleLinks(
    siteConfig.key === 'solitairestack'
      ...
      : [
          ...
          { href: '/daily-freecell/room', label: 'Daily Room' },
  ...
  const learnLinks = visibleLinks(
    siteConfig.key === 'solitairestack'
      ? [
          ...
          { href: '/tripeaks/tips', label: 'TriPeaks Tips' },
          { href: '/tripeaks/strategy', label: 'TriPeaks Strategy' },
          { href: '/golf/how-to-play', label: 'Golf Rules' },
          { href: '/golf/tips', label: 'Golf Tips' },
          { href: '/golf/strategy', label: 'Golf Strategy' },
          ...
          { href: '/canfield/strategy', label: 'Canfield Strategy' },
      ...
      : [
          ...
          { href: '/freecell-em-portugues', label: 'FreeCell em Portugues' },
          { href: '/freecell-em-portugues/jogar', label: 'Jogar em Portugues' },
          ...
          { href: '/bakers-game/tips', label: "Baker's Game Tips" },
          { href: '/eight-off/how-to-play', label: 'Eight Off Rules' },
          { href: '/eight-off/strategy', label: 'Eight Off Strategy' },
          { href: '/eight-off/tips', label: 'Eight Off Tips' },
          { href: '/forty-thieves/how-to-play', label: 'Forty Thieves Rules' },
          { href: '/forty-thieves/tips', label: 'Forty Thieves Tips' },
          { href: '/forty-thieves/strategy', label: 'Forty Thieves Strategy' },
          { href: '/scorpion/how-to-play', label: 'Scorpion Rules' },
