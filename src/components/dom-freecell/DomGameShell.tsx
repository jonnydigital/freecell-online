...
const UI_COPY = {
  ...
  fr: {
    appTitle: 'FreeCell en Francais',
    dateLocale: 'fr',
    time: 'Temps',
    moves: 'Coups',
    movesShort: 'coups',
    gameBoard: 'Tableau de FreeCell',
    gameNumberTitle: 'Cliquez pour saisir un numero de partie',
    enterGameNumberTitle: 'Saisir un numero de partie',
    ...
    ghostModeTitle: 'Mode fantome - regardez le solveur jouer',
    bookmarkGame: 'Sauvegarder la partie',
    removeBookmark: 'Retirer la sauvegarde',
    statistics: 'Statistiques',
    settings: 'Reglages',
    gameResumed: 'Partie reprise',
    savedGameAvailable: 'Partie sauvegardee disponible',
    resume: 'Reprendre',
    dismissResumeNotice: 'Fermer l avis de reprise',
    dismissSavedGamePrompt: 'Fermer l avis de partie sauvegardee',
    dismissHint: 'Fermer l indice',
    autoFinish: 'Fin auto',
    solving: 'Resolution...',
    solverFailed: 'Aucune solution trouvee',
    dismiss: 'Fermer',
    noMovesNeeded: 'Aucun coup necessaire',
    noMoreMoves: 'Plus aucun coup',
    noMoreMovesBody: 'La partie est arrivee a un etat sans mouvement legal.',
    undoLastMove: 'Annuler le dernier coup',
    restartDeal: 'Recommencer la donne',
    giveUpNewDeal: 'Abandonner et nouvelle donne',
    playSpecificGame: 'Jouer une partie precise',
    enterNumberPrompt: 'Saisissez un numero de partie (1 - 9,999,999):',
    gameNumberPlaceholder: 'ex. 12345',
    gameNumberError: 'Saisissez un numero entre 1 et 9,999,999',
    cancel: 'Annuler',
    play: 'Jouer',
    close: 'Fermer',
    todaysChallenge: 'Defi du jour',
    completed: 'Termine',
    playTodaysChallenge: 'Jouer le defi du jour',
    copied: 'Copie!',
    share: 'Partager',
    played: 'Jouees',
    win: 'Victoires',
    streak: 'Serie',
    howToPlay: 'Regles',
    howToPlayHref: '/freecell-en-francais',
    strategy: 'Strategie',
    ...
    gameplay: 'Jeu',
    autoFinishDescription: 'Termine automatiquement quand la partie est clairement gagnee',
    oneTapMoves: 'Un clic',
    oneTapMovesDescription: 'Deplacer les cartes en un seul clic',
    tryThisMove: 'Essayez ce coup',
    noHintsAvailable: 'Aucun indice disponible; essayez d annuler un coup',
    gameBookmarked: (gameNumber: number) => `Partie #${gameNumber} sauvegardee`,
    bookmarkRemoved: 'Sauvegarde retiree',
    shareText: (gameNumber: number, shareUrl: string) =>
      `Je joue a FreeCell partie #${gameNumber}. Pouvez-vous faire mieux? ${shareUrl}`,
    shareTitle: 'FreeCell en Francais',
    sharePath: (gameNumber: number) => `/freecell-en-francais/jouer?game=${gameNumber}`,
    resumedAnnouncement: (gameNumber: number, moveCount: number) =>
      `Partie ${gameNumber} reprise avec ${moveCount} coups.`,
    newGameStartedAnnouncement: 'Nouvelle partie commencee.',
    winAnnouncement: (moveCount: number) => `Bravo. Vous avez gagne en ${moveCount} coups.`,
    deadlockAnnouncement: 'Aucun mouvement legal restant. La partie est bloquee.',
    gameRestartedAnnouncement: 'Partie recommencee.',
    moveUndoneAnnouncement: 'Coup annule',
    moveRedoneAnnouncement: 'Coup retabli',
    hintShownAnnouncement: 'Indice affiche',
    autoCompletingAnnouncement: 'Fin automatique de la partie',
  },
  de: {
    appTitle: 'FreeCell auf Deutsch',
    dateLocale: 'de',
    time: 'Zeit',
    moves: 'Zuege',
    movesShort: 'Zuege',
    gameBoard: 'FreeCell-Spielfeld',
    gameNumberTitle: 'Klicken, um eine Spielnummer einzugeben',
    enterGameNumberTitle: 'Spielnummer eingeben',
    newDeal: 'Neue Partie',
    newGame: 'Neue Partie',
    menu: 'Menu',
    new: 'Neu',
    ...
    ghostModeTitle: 'Geistermodus - dem Solver zusehen',
    bookmarkGame: 'Partie speichern',
    removeBookmark: 'Speicherung entfernen',
    statistics: 'Statistiken',
    settings: 'Einstellungen',
    gameResumed: 'Partie fortgesetzt',
    savedGameAvailable: 'Gespeicherte Partie verfuegbar',
    resume: 'Fortsetzen',
    dismissResumeNotice: 'Fortsetzungs-Hinweis schliessen',
    dismissSavedGamePrompt: 'Hinweis zur gespeicherten Partie schliessen',
    dismissHint: 'Hinweis schliessen',
    autoFinish: 'Auto-Ende',
    solving: 'Loesung wird gesucht...',
    solverFailed: 'Keine Loesung gefunden',
    dismiss: 'Schliessen',
    noMovesNeeded: 'Keine Zuege noetig',
    noMoreMoves: 'Keine Zuege mehr',
    noMoreMovesBody: 'Die Partie hat einen Zustand ohne legale Zuege erreicht.',
    undoLastMove: 'Letzten Zug rueckgaengig',
    restartDeal: 'Partie neu starten',
    giveUpNewDeal: 'Aufgeben und neue Partie',
    playSpecificGame: 'Bestimmte Partie spielen',
    enterNumberPrompt: 'Spielnummer eingeben (1 - 9,999,999):',
    gameNumberPlaceholder: 'z. B. 12345',
    gameNumberError: 'Geben Sie eine Zahl zwischen 1 und 9,999,999 ein',
    cancel: 'Abbrechen',
    play: 'Spielen',
    close: 'Schliessen',
    todaysChallenge: 'Heutige Herausforderung',
    completed: 'Abgeschlossen',
    playTodaysChallenge: 'Heutige Herausforderung spielen',
    copied: 'Kopiert!',
    share: 'Teilen',
    played: 'Gespielt',
    win: 'Siege',
    streak: 'Serie',
    howToPlay: 'Regeln',
    howToPlayHref: '/freecell-auf-deutsch',
    strategy: 'Strategie',
    ...
    gameplay: 'Spiel',
    autoFinishDescription: 'Automatisch beenden, wenn die Partie klar gewonnen ist',
    oneTapMoves: 'Ein-Klick-Zuege',
    oneTapMovesDescription: 'Karten mit einem Klick bewegen',
    tryThisMove: 'Diesen Zug versuchen',
    noHintsAvailable: 'Keine Hinweise verfuegbar; versuchen Sie, einen Zug rueckgaengig zu machen',
    gameBookmarked: (gameNumber: number) => `Partie #${gameNumber} gespeichert`,
    bookmarkRemoved: 'Speicherung entfernt',
    shareText: (gameNumber: number, shareUrl: string) =>
      `Ich spiele FreeCell Partie #${gameNumber}. Schaffen Sie sie besser? ${shareUrl}`,
    shareTitle: 'FreeCell auf Deutsch',
    sharePath: (gameNumber: number) => `/freecell-auf-deutsch/spielen?game=${gameNumber}`,
    resumedAnnouncement: (gameNumber: number, moveCount: number) =>
      `Partie ${gameNumber} mit ${moveCount} Zuegen fortgesetzt.`,
    newGameStartedAnnouncement: 'Neue Partie gestartet.',
    winAnnouncement: (moveCount: number) => `Glueckwunsch. Sie haben in ${moveCount} Zuegen gewonnen.`,
    deadlockAnnouncement: 'Keine legalen Zuege mehr. Die Partie steckt fest.',
    gameRestartedAnnouncement: 'Partie neu gestartet.',
    moveUndoneAnnouncement: 'Zug rueckgaengig gemacht',
