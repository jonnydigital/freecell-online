    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--theme-dark, #0a3310)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 16px', background: 'rgba(0,0,0,0.3)', borderBottom: '1px solid rgba(255,255,255,0.06)', flexWrap: 'wrap', gap: '8px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          {onUndo && (
            <button onClick={onUndo} aria-label="Undo" title="Undo" style={{ minWidth: '44px', minHeight: '44px', padding: '8px', borderRadius: '8px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.6)', cursor: 'pointer' }}>↩</button>
          )}
          {onHint && (
            <button onClick={onHint} aria-label="Hint" title="Hint" style={{ minWidth: '44px', minHeight: '44px', padding: '8px', borderRadius: '8px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.6)', cursor: 'pointer' }}>💡</button>
          )}
