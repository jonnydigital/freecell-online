...
class GameBridge {
  ...
  /** Game variant: 'freecell' (default), 'bakers-game'/'eight-off' (same-suit stacking), 'easy-freecell' (pre-placed aces+2s), restricted-cell variants, 'spider', 'klondike', or 'pyramid' */
