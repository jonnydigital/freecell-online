...
export interface Author {
  ...
  expertise: string[];
  bioShort: string;
  /** Optional SEO meta description (<=160 chars). Falls back to bioShort when omitted. */
...
export const AUTHORS: Record<AuthorSlug, Author> = {
  'editorial-team': {
    ...
    metaDescription:
      'Meet the Solitaire Stack Editorial Team — we set editorial standards and coordinate our Strategy, History, Rules, and Research desks across the network.',
    bioFull:
    ...
    avatarUrl: '/authors/editorial-team.svg',
  ...
  'the-strategy-desk': {
    ...
    metaDescription:
      'The Strategy Desk publishes solitaire tactics that hold up at the table: FreeCell supermoves, Klondike draw-3 decisions, and Spider empty-column valuation.',
    bioFull:
    ...
    avatarUrl: '/authors/strategy-desk.svg',
    joinedDate: '2026-01-15',
  ...
  'the-history-desk': {
    ...
    metaDescription:
      'The History Desk traces solitaire variants to their French patience origins, documents how the games evolved, and keeps legend separate from sourced fact.',
    bioFull:
    ...
    avatarUrl: '/authors/history-desk.svg',
    joinedDate: '2026-01-15',
  ...
  'the-rules-desk': {
    ...
    metaDescription:
      'The Rules Desk documents canonical rules for every solitaire variant we cover, flags where versions differ, and writes how-to guides that teach beginners.',
    bioFull:
    ...
    avatarUrl: '/authors/rules-desk.svg',
    joinedDate: '2026-01-15',
  ...
  'j-foye': {
    ...
    metaDescription:
      'J. Foye is the editor and founder of the Solitaire Stack network — building the products, running editorial standards, and signing off on every page.',
    bioFull:
  ...
  'the-research-desk': {
    ...
    metaDescription:
      'The Research Desk builds solvers, runs Monte Carlo simulations, and publishes solitaire win rates with methodology and confidence intervals, not copied numbers.',
    bioFull:
    ...
    avatarUrl: '/authors/research-desk.svg',
    joinedDate: '2026-01-15',
